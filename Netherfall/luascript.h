...
protected:
	...
	//dungeons
	static int luaDoCreateNewDungeon(lua_State* L);
	//lua functions
	...
	static int luaDoCoverGround(lua_State *L);
	...
	static int luaDoPlayerAddItemWithAttribute(lua_State *L);
	...
	static int luaGetItemMagicAttributes(lua_State *L);
	...
	static int luaDoItemAddAttribute(lua_State *L);
	...
	static int luaOnCreatureDie(lua_State *L);
